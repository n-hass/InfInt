...
/* non-member operators */
inline InfInt operator+(char const* lhs, InfInt const& rhs) { return InfInt(lhs) + rhs; }
inline InfInt operator+(std::string const& lhs, InfInt const& rhs) { return InfInt(lhs) + rhs; }
inline InfInt operator+(int lhs, InfInt const& rhs) { return InfInt(lhs) + rhs; }
inline InfInt operator+(long lhs, InfInt const& rhs) { return InfInt(lhs) + rhs; }
inline InfInt operator+(long long lhs, InfInt const& rhs) { return InfInt(lhs) + rhs; }
inline InfInt operator+(unsigned int lhs, InfInt const& rhs) { return InfInt(lhs) + rhs; }
inline InfInt operator+(unsigned long lhs, InfInt const& rhs) { return InfInt(lhs) + rhs; }
inline InfInt operator+(unsigned long long lhs, InfInt const& rhs) { return InfInt(lhs) + rhs; }
